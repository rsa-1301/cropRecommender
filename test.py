...
state = sys.argv[1]#Must be selected from StateDisList in UI
dis = sys.argv[2]  #Must be selected from StateDisList on basis of selected state in UI
season = sys.argv[3]

with open('D:/SEM 6/ML Project/Implementation/JSON/state_dis_loc.json') as json_file:
    StateDisList = json.load(json_file)
with open('D:/SEM 6/ML Project/Implementation/JSON/SeasonwiseCrops.json') as json_file:
    SeasonWiseCrops = json.load(json_file)    
with open('D:/SEM 6/ML Project/Implementation/JSON/SavedModelInfoNew.json') as json_file:
    SavedModelInfo = json.load(json_file)
with open('D:/SEM 6/ML Project/Implementation/JSON/ProduceInfo.json') as json_file:
...
dbfile = open('D:/SEM 6/ML Project/Implementation/stdScaler', 'rb')      
